<div id="mod-buildings" tabindex="-1" role="dialog" class="modal fade" data-backdrop="static">
        ...
        <div class="modal-content" style="overflow:visible">
            ...
            <div class="modal-body">
                <form class="jsSubmit" autocomplete="off" action="{{ route('app.marketing-communications.create') }}" data-reset="true" method="POST">
                    {{ csrf_field() }}
                    @php $fields = json_decode(json_encode(\App\Models\MarketingCommunications::building_form_fields())); @endphp
                    ...
                    <div class="form-group _invite_resident checkbox mb-4 mt-3">
                        <div class="checkbox">
                            <input type="checkbox" id="status_building" name="status" class="" value="1"
                                data-parsley-multiple="status" checked>
                            <label for="status_building">Send Email(SMS) to resident(s) on creation?</label>
                        </div>
                    </div>
