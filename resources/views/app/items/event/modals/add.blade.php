...
<div id="mod-item-event" tabindex="-1" role="dialog" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content" style="overflow:visible">
            ...
            <div class="modal-body">
                <form method="POST" action="{{route('app.item.store', 'event')}}" autocomplete="off">
                    {{ csrf_field() }}

                    @php $fields = json_decode(json_encode(\App\Models\BookableItem::form_event_fields())); @endphp
