<div id="mod-hire" tabindex="-1" role="dialog" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content" style="overflow:visible">
            ...
            <div class="modal-body">
                <form method="POST" action="{{route('app.item.store', ['type' => 'hire', 'item_id' => $item->id])}}" data-reload="true" autocomplete="off">
                    {{ csrf_field() }}
