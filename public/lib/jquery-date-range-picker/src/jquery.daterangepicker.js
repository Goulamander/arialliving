...
(function(factory) {
    ...
    $.dateRangePickerLanguages = {
        "default": //default language: English
        {
            ...
            "default-default": "Please select start and due date",
            "time": "Time",
            "hour": "Hour",
            "minute": "Minute"
        },
            ...
            if (day.hasClass('has-tooltip') && day.attr('data-tooltip')) {
                ...
                if (opt.singleDate) {
                    ...
                    if (opt.start && !opt.end) {
                        ...
                        var weekends = $('.date-picker-wrapper .month-wrapper table .day.weekend.hovering').length;
                        var days = ( countDays(hoverTime, opt.start) - weekends);
